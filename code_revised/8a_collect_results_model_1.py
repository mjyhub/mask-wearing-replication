...
# -*- coding: utf-8 -*-
"""
Collect the cross validation results for model_1
Adapted for your current file names
"""
...
model_files = {
    ...
    "binary_tree": f"../results/{model_number}_binary_tree.pkl",
    "xgboost": f"../results/{model_number}_xgboost.pkl",
