'''
Small grid search for model_2b xgboost
...
param_grid = {
    "learning_rate": [0.02, float(original_best["learning_rate"])],
    "subsample": [0.50, float(original_best["subsample"])],
    "gamma": [0.03, float(original_best["gamma"])]
}
...
# %% Run small grid
for i, (learning_rate, subsample, gamma) in enumerate(all_combos, start=1):
