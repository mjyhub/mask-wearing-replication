'''
Small grid search for model_1b binary tree
...
param_grid = {
    "max_depth": [10, int(float(original_best["max_depth"]))],
    "min_weight_fraction_leaf": [0.0015, float(original_best["min_weight_fraction_leaf"])],
    "min_impurity_decrease": [0.00015, float(original_best["min_impurity_decrease"])]
}
...
# %% Run small grid
for i, (max_depth, min_weight_fraction_leaf, min_impurity_decrease) in enumerate(all_combos, start=1):
